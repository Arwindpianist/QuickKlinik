    ...
    <div className="flex flex-1 flex-col gap-6 p-4 sm:p-6">
      <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Manage tenants by type, subscription package, size, and features.
        </p>
      </div>
      ...
      {analytics.length > 0 && (
        <PageAnalyticsCard
          ...
          stats={[
            { label: "Tenants", value: analytics.length },
      ...
      {analytics.length > 0 && (
        <Card className="animate-in fade-in slide-in-from-bottom-2 duration-300 delay-75 fill-mode-backwards">
          <CardHeader className="pb-2">
            <CardTitle className="text-base">Per-tenant metrics</CardTitle>
            <p className="text-sm text-muted-foreground">Appointments and OTC/inventory summary by tenant</p>
          </CardHeader>
          <CardContent>
